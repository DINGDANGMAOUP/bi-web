...
<!--      <v-tab class="tabs" :class="$store.state.app.collapse?'position-collapse-left':'position-left'"-->
<!--               v-model="mainTabsActiveName" :closable="true" type="card"-->
<!--               @tab-click="selectedTabHandle" @tab-remove="removeTabHandle">-->
<!--        <v-navigation-drawer class="tabs-tools" :show-timeout="0" trigger="hover">-->
<!--          <div style="font-size:20px;width:50px;"><i class="el-icon-arrow-down"></i></div>-->

<!--        </v-navigation-drawer>-->
<!--        <v-tab-item v-for="item in mainTabs"-->
